...
public class CalendarView extends FrameLayout {
    ...
    private void init(Context context) {
        ...
        frameContent.setBackgroundResource(R.drawable.bg_tsl_calendar);
     ...
     * 滚动到上一年
     */
    public void scrollToPreYear() {
        mMonthPager.setCurrentItem(mMonthPager.getCurrentItem() - 12, false);
    }
    /**
     * 滚动到下一年
     */
